...
const navItems: { page: Page; label: string; icon: string; group: string }[] = [
  ...
  { page: "learning", label: "Rule learning", icon: "learning", group: "" },
  { page: "comparison", label: "Compare", icon: "comparison", group: "" },
...
function Icon({ name }: { name: string }) {
  const paths: Record<string, string> = {
    ...
    reviews: "M6 4h12v16H6z M9 4V2h6v2 M9 10h6 M9 14h3 M9 18l2 2 4-5",
    learning: "M4 5h16v11H9l-5 4z M8 9h8 M8 13h5",
    comparison: "M4 7h12 M12 3l4 4-4 4 M20 17H8 M12 13l-4 4 4 4",
